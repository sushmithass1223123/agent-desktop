...
-   **Interaction Details Widget:** Paginator was not issue fixed `🛠`
-   Instant Messaging Component: The UI gets miss aligned when clicked on new IM notification issue fixed `🛠`
