...
@Component({
    ...
    templateUrl: './tw-ad-total-chats.component.html',
    styleUrls: ['./tw-ad-total-chats.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class TwAdTotalChatsComponent extends TWidgetWrapper implements OnInit, OnDestroy {
