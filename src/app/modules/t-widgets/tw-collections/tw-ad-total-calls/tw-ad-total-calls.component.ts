...
@Component({
    selector: 'tw-ad-total-calls',
    templateUrl: './tw-ad-total-calls.component.html',
    styleUrls: ['./tw-ad-total-calls.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class TwAdTotalCallsComponent extends TWidgetWrapper implements OnInit, OnDestroy {
